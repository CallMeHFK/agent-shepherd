...
```bash
# The package is not on PyPI. Either of these two:
pip install https://github.com/CallMeHFK/agent-shepherd/releases/latest/download/agent_shepherd-0.2.1-py3-none-any.whl
uv pip install "git+https://github.com/CallMeHFK/agent-shepherd.git"   # @v0.2.1 to pin
